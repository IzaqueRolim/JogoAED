...
public class InsertionSort : MonoBehaviour
{
    ...
    {
        string dadosRecuperadosJSON = PlayerPrefs.GetString("MeusDadosInsertionSort", "");
        ...
        if (dadosOrdenados.Count > 0)
        {
            ...
            PlayerPrefs.SetString("MeusDadosInsertionSort", dadosJSON);
            PlayerPrefs.Save();
        }
    }
    ...
    public void SomarMoedas()
    {
        ...
        PlayerPrefs.SetInt("moedas", qtdMoedas + 300);
    }

...
public class SelectionSort : MonoBehaviour
{
    ...
    {
        string dadosRecuperadosJSON = PlayerPrefs.GetString("MeusDadosSelectionSort", "");
        ...
        if (dadosOrdenados.Count > 0)
        {
            ...
            PlayerPrefs.SetString("MeusDadosSelectionSort", dadosJSON);
            PlayerPrefs.Save();
        }
    }
    ...
    public int ReordenarArray(int elementoASerBuscado)
    {
        ...
        TrocarElementosNaLista(elementos, indiceElemento + 1, indiceElemento);
    ...
    public void SomarMoedas()
    {
        ...
        PlayerPrefs.SetInt("moedas", qtdMoedas + 400);
    }

    public void OrdenarLista()
    {
        elementos.Sort((a, b) => b.CompareTo(a));
        SetarListaComoOrdenada();
        listaOrdenada = true;
    }
